...
<head>
    ...
    <title>shop washing machine</title>
...
<header>
    ...
    <div class="cont1">
        <div class="Rect1">
            <div class="contimg">
                <img class="im1" src="./washing1.jpg">
            </div>
            <div class="conttext">
                <h1 class="text1"> GE - 4.2 Cu. Ft. Top Load Washer <br> with Precise Fill & Deep Rinse - White on White
                
                <h1 class="text2">$539.99</h1>
                <a href ="panier.php"> <button  class="button" id="submit" type="submit"> Shop Now </button></a>
            </div>
        </div>
        <div class="Rect2">
            <div class="contimg">
                <img class="im2" src="./washing2.jpg">
            </div>
            <div class="conttext">
                <h1 class="text1"> LG - 5.5 Cu. Ft. High Efficiency Smart Top Load Washer with TurboWash3D - Graphite Steel 
                </h1>
